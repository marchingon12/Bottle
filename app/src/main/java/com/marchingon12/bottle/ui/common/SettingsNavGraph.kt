...
import com.marchingon12.bottle.ui.screens.settings.about.*
...
fun NavGraphBuilder.settingsNavGraph(
    ...
    navigation(
        ...
        dialog(Route.CHANGELOG) { ChangelogDialog { onBackPressed() } }
        dialog(Route.DONATION) { DonationDialog { onBackPressed() } }
        composable(Route.ABOUT) {
            AboutScreen(
                navController = navController,
                onBackPressed = onBackPressed,
                onOpenChangelogDialog = { navController.navigate(Route.CHANGELOG)},
